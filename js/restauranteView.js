...
class RestaurantView {
  ...
  showModifyCatForm(categories, dishes) {
    ...
    container.insertAdjacentHTML('afterbegin', '<h1 class="display-5">Modificar categorías de un plato</h1>');
    ...
    form.insertAdjacentHTML('beforeend', `<div class="col-md-5 mb-3">
                <div class="input-group">
    ...
    for (const category of categories) {
        mcCategories.insertAdjacentHTML('beforeend', 
        `<option value="${category.category.name}">${category.category.name}</option>`);
    }

    form.insertAdjacentHTML('beforeend', `<div class="mb-12">
...
bindModifyCatForm(handler) {
  ...
  modifyBreadcrumb(category){
    ...
    breadcrumb.insertAdjacentHTML('beforeend', `<li class="breadcrumb-item"><a href="../index.html">Inicio</a></li>`);
